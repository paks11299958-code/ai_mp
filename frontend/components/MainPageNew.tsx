...
export const FEATURES_GRID = [
    { id: 1,  numeral: 'I',   latin: 'News',    key: 'news',    name: '오늘 뉴스',      tag: 'AI 뉴스 브리핑', catch: '매일 아침, 핵심만 딱 3분 ☕', category: 'info',    desc: '매일 아침 AI가 핵심만 골라 요약 전달. 9개 카테고리 중 원하는 분야를 선택하세요.',         icon: 'newspaper', palette: { bg: '#E8EEF7', deep: '#9AAFCB', accent: '#5C7BA8' }, personaName: '서아',    releasedAt: '2026-05-01' },
    { id: 2,  numeral: 'II',  latin: 'Stock',   key: 'stock',   name: '주식 분석',      tag: 'AI 투자 리포트', catch: '3중 AI가 종목을 파헤쳐요 🔎', category: 'invest',  desc: '종목명만 입력하면 Gemini·Claude·GPT 3중 AI가 투자 리포트를 드려요.',                     icon: 'chart',     palette: { bg: '#E0EFE3', deep: '#9CC4A7', accent: '#2E6B32' }, personaName: '윤채원',  releasedAt: '2026-05-01' },
    { id: 3,  numeral: 'III', latin: 'Swing',   key: 'swing',   name: '스윙 분석',      tag: '골프 AI 코치',   catch: '내 스윙, 어디가 문제일까? 🏌️', category: 'hobby',   desc: '스윙 영상을 올리면 AI가 5개 항목을 분석해 개선점을 제안해요. 나만의 AI 골프 코치.',        icon: 'golf',      palette: { bg: '#FEF6E8', deep: '#E2C9A0', accent: '#8B6020' }, personaName: '설아',    releasedAt: '2026-05-01' },
    { id: 4,  numeral: 'IV',  latin: 'Luxury',  key: 'luxury',  name: '명품 감정',      tag: '진품 여부 판별', catch: '진짜일까 가짜일까, 사진으로 판별', category: 'invest',  desc: '사진만 올리면 AI가 브랜드 진위 여부를 분석해 감정 리포트를 드려요.',                        icon: 'shield',    palette: { bg: '#F0EAF8', deep: '#C4A8D8', accent: '#7A5FA0' }, personaName: '신은비',  releasedAt: '2026-05-01' },
    { id: 5,  numeral: 'V',   latin: 'Insurance',key: 'insurance',name: '보험 컨설팅',    tag: '중복보장 분석',  catch: '내 보험, 잘 든 걸까요? 🤔', category: 'invest',  desc: '가입한 보험을 올리면 AI가 중복·부족 보장을 분석해 컨설팅 리포트를 드려요.',                  icon: 'umbrella',  palette: { bg: '#E6EEF6', deep: '#9BB4CE', accent: '#3E6695' }, personaName: '정우진',  releasedAt: '2026-06-14' },
    { id: 6,  numeral: 'VI',  latin: 'Used',    key: 'used',    name: '중고 판매',      tag: '중고마켓 도우미',catch: '사진 한 장이면 판매글 완성 ✍️', category: 'invest',  desc: 'AI가 중고 상품 설명을 대신 작성해줘요. 사진 한 장으로 판매글 완성.',                        icon: 'shopping',  palette: { bg: '#FCEADD', deep: '#E2B89A', accent: '#C68760' }, personaName: '이아린',  releasedAt: '2026-05-01' },
    { id: 7,  numeral: 'VII', latin: 'Keyword', key: 'hotkeyword', name: '핫 키워드',      tag: '쇼핑 트렌드',    catch: '지금 뭐가 잘 팔릴까? 🔥', category: 'invest',  desc: '실시간 인기 쇼핑 키워드를 AI가 분석해 트렌드를 알려드려요.',                               icon: 'sparkles',  palette: { bg: '#E4ECEE', deep: '#9DB6BC', accent: '#5E7E86' }, personaName: '이아린',  releasedAt: '2026-05-01' },
    { id: 8,  numeral: 'VIII',latin: 'Math',    key: 'mathtutor', name: 'AI 수학 튜터',   tag: '학습 도우미',    catch: '막힌 문제, 단계별로 술술 ✏️', category: 'info',    desc: '단계별 풀이로 수학 문제를 해결해 드려요. 개념 설명부터 심화까지.',                           icon: 'book',      palette: { bg: '#FDE6F0', deep: '#F4A4C6', accent: '#D85C95' }, personaName: '지우',    releasedAt: '2026-06-13' },
    { id: 9,  numeral: 'IX',  latin: 'Club',    key: 'club',    name: '모임 출첵',      tag: '커뮤니티 관리',  catch: '출석 체크, QR로 간편하게 📍', category: 'life',    desc: '모임 출석 체크와 멤버 관리를 AI가 도와드려요.',                                             icon: 'people',    palette: { bg: '#E5E1F2', deep: '#A99DCC', accent: '#6E5DA3' }, personaName: '지우',    releasedAt: '2026-06-06' },
    { id: 10, numeral: 'X',   latin: 'Fortune', key: 'siwoon',  name: '시운의 흐름',    tag: '운세 · 토정비결', catch: '오늘 나의 운은 어떨까요? 🌙', category: 'fortune', desc: '',  subItems: ['📅 오늘의 운세', '🌙 이달의 흐름', '🌟 올해의 비결'], icon: 'fortune',   palette: { bg: '#EEE5F8', deep: '#B8A0D8', accent: '#6B4FA0' }, personaName: '도결(道潔) 선생', releasedAt: '2026-06-05' },
    { id: 11, numeral: 'XI',  latin: 'Wealth',  key: 'wealth',  name: '성취와 재물',    tag: '재물 · 사업 운세', catch: '돈과 일, 흐름을 미리 봐요 💰', category: 'fortune', desc: '', subItems: ['💰 재물 흐름', '🏆 사업 / 성취'],                   icon: 'coin',      palette: { bg: '#FDF6E0', deep: '#E8C86A', accent: '#A07828' }, personaName: '도결(道潔) 선생', releasedAt: '2026-06-05' },
    { id: 12, numeral: 'XII', latin: 'Love',    key: 'yeonn',   name: '인연의 결',      tag: '연애 · 궁합 운세', catch: '그 사람과 나, 잘 맞을까? 💑', category: 'fortune', desc: '', subItems: ['❤️ 연애 운세', '💑 인연 궁합'],                   icon: 'heart',     palette: { bg: '#FDE8F0', deep: '#E8A0BC', accent: '#B84070' }, personaName: '도결(道潔) 선생', releasedAt: '2026-06-05' },
    { id: 13, numeral: 'XIII',latin: 'Dream',   key: 'dream',   name: '꿈해몽',         tag: 'AI 꿈 풀이',      catch: '어젯밤 그 꿈, 무슨 뜻일까? 💭', category: 'fortune', desc: '어젯밤 꾼 꿈을 들려주시면 도결 선생이 그 뜻을 풀어드려요.',                                  icon: 'moon',      palette: { bg: '#E8E4F5', deep: '#A898D0', accent: '#5848A0' }, personaName: '도결(道潔) 선생', releasedAt: '2026-06-05' },
    { id: 14, numeral: 'XIV', latin: 'Gwansang',key: 'gwansang',name: '관상학',         tag: 'AI 관상 분석',    catch: '얼굴에 답이 있대요 😌', category: 'fortune', desc: '얼굴 사진 한 장으로 도결 선생이 관상과 성격·운세를 풀어드려요.',                              icon: 'gwansang',  palette: { bg: '#F0EAE0', deep: '#C8B098', accent: '#886040' }, personaName: '도결(道潔) 선생', releasedAt: '2026-06-05' },
    { id: 15, numeral: 'XV',  latin: 'Ebook',   key: 'ebook',   name: '전자책 만들기',  tag: 'AI 출판 도우미', catch: '주제만 정하면 내 책이 뚝딱 📕', category: 'create',  desc: '주제만 정하면 AI가 목차·본문·표지를 만들어 전자책(.docx)으로 완성해드려요.',                icon: 'ebook',     palette: { bg: '#EDE8F6', deep: '#B6A4D8', accent: '#6A4FA0' }, personaName: '강지훈',  releasedAt: '2026-06-11' },
    { id: 16, numeral: 'XVI', latin: 'Webtoon', key: 'webtoon', name: '웹툰 보기',      tag: 'AI 웹툰 연재',   catch: '향기 작가의 웹툰, 한 컷씩 몰입 🖼️', category: 'create',  desc: '향기 작가가 연재하는 웹툰을 회차별로 감상하세요. 한 컷씩 풀스크린으로.',                      icon: 'webtoon',   palette: { bg: '#FCE8EF', deep: '#F0A8C4', accent: '#C84D85' }, personaName: '향기(필명)', releasedAt: '2026-06-12' },
    { id: 17, numeral: 'XVII',latin: 'Hair',    key: 'hair',    name: '헤어Style',tag: 'AI 뷰티 컨설팅', catch: '자르기 전에 미리 써봐요 ✂️', category: 'life',    desc: '내 사진을 올리고 헤어스타일을 고르면 윤채린이 어울리는지 진단해드려요.',                      icon: 'hair',      palette: { bg: '#F3E9F4', deep: '#D4A8DC', accent: '#9B5FA8' }, personaName: '윤채린',  releasedAt: '2026-06-16' },
    { id: 23, numeral: 'XXIII',latin: 'Profile', key: 'outfit',  name: '프로필 사진',tag: 'AI 프로필', catch: '실사부터 지브리·베이비까지, 나만의 프사 📸', category: 'life',    desc: '내 얼굴 사진만 올리면 실사는 물론 지브리·픽사·민화풍, 귀여운 베이비·치비 캐릭터까지 다양한 컨셉의 프로필 사진을 만들어드려요.',       icon: 'outfit',    palette: { bg: '#F3E9F4', deep: '#D4A8DC', accent: '#8E6FB7' }, personaName: '윤채린',  releasedAt: '2026-07-12' },
    { id: 18, numeral: 'XVIII',latin: 'Lookalike',key: 'lookalike',name: '연예인 매칭',tag: 'AI 닮은꼴 분석', catch: '나랑 닮은 스타는 누구? ✨', category: 'life',    desc: '내 사진을 올리면 윤채린이 닮은 연예인을 찾아드려요. 친구에게 자랑해 보세요!',                  icon: 'face',      palette: { bg: '#F0E8F8', deep: '#C4A9E0', accent: '#8E6FB7' }, personaName: '윤채린',  releasedAt: '2026-06-24' },
...
export const FEATURE_SYNONYMS: Record<string, string[]> = {
    ...
    tarot:       ['타로', '타로점', '타로카드', '카드점', '점', '리딩', '유나', '점괘'],
    ...
    // ★'프롬프트'는 전자책 그림 프롬프트와도 겹치는 말이라, 이미지에서 뽑는다는 방향을
    //   드러내는 말(역추출·따오기)과 도구 이름(미드저니·스테이블디퓨전)을 함께 넣는다.
...
export const MpnFeatureIcon: React.FC<{ kind: string; size?: number; color?: string; bg?: string }> = ({ kind, size = 64, color = '#8E6FB7', bg = '#F5E6F7' }) => {
    ...
    switch (kind) {
        ...
        case 'tarot':     return <svg width={size} height={size} viewBox="0 0 96 96" fill="none"><rect x="18" y="26" width="26" height="42" rx="4" fill={a} opacity="0.45" transform="rotate(-14 31 47)"/><rect x="52" y="26" width="26" height="42" rx="4" fill={a} opacity="0.45" transform="rotate(14 65 47)"/><rect x="35" y="20" width="26" height="44" rx="4" fill={c} opacity="0.9"/><path d="M48 30 l3.2 6.6 7.2 1 -5.2 5 1.2 7.2 -6.4-3.4 -6.4 3.4 1.2-7.2 -5.2-5 7.2-1z" fill="#FDFAF6" opacity="0.9"/></svg>;
        ...
        case 'outfit':    return <svg width={size} height={size} viewBox="0 0 96 96" fill="none"><rect x="14" y="30" width="68" height="46" rx="8" fill={c} opacity="0.9"/><rect x="36" y="18" width="24" height="14" rx="4" fill={c} opacity="0.9"/><circle cx="48" cy="54" r="16" fill="none" stroke={a} strokeWidth="3"/><circle cx="48" cy="54" r="8" fill={a} opacity="0.8"/><circle cx="70" cy="40" r="3" fill={a} opacity="0.6"/></svg>;
...
const PersonaSelectPanel: React.FC<{
    ...
    const renderFeatureCard = (feat: typeof FEATURES_GRID[number], i: number) => {
        ...
        const catchCopy = (feat as any).catch as string | undefined;
        const W = 160, H = 280;
        return (
            <div key={feat.key}
