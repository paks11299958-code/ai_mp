...
export const FEATURES_GRID = [
    ...
    { id: 17, numeral: 'XVII',latin: 'Hair',    key: 'hair',    name: '헤어Style',tag: 'AI 뷰티 컨설팅', category: 'life',    desc: '내 사진을 올리고 헤어스타일을 고르면 윤채린이 어울리는지 진단해드려요.',                      icon: 'hair',      palette: { bg: '#F3E9F4', deep: '#D4A8DC', accent: '#9B5FA8' }, personaName: '윤채린',  releasedAt: '2026-06-16' },
