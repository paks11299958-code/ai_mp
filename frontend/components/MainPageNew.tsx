...
export const FEATURES_GRID = [
    ...
    { id: 5,  numeral: 'V',   latin: 'Face',    key: 'face',    name: '얼굴형 분석',    tag: 'AI 관상 분석',   desc: '셀카 한 장으로 AI가 관상·성격·운세를 재미있게 풀어드려요.',                                 icon: 'face',      palette: { bg: '#FAE3EA', deep: '#E8A8BC', accent: '#C76A8A' }, personaName: '도결'    },
