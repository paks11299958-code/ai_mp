...
export const FEATURES_GRID = [
    ...
    { id: 5,  numeral: 'V',   latin: 'Insurance',key: 'insurance',name: '보험 컨설팅',    tag: '중복보장 분석',  category: 'invest',  desc: '가입한 보험을 올리면 AI가 중복·부족 보장을 분석해 컨설팅 리포트를 드려요.',                  icon: 'umbrella',  palette: { bg: '#E6EEF6', deep: '#9BB4CE', accent: '#3E6695' }, personaName: '정우진'  },
    ...
    { id: 15, numeral: 'XV',  latin: 'Ebook',   key: 'ebook',   name: '전자책 만들기',  tag: 'AI 출판 도우미', category: 'create',  desc: '주제만 정하면 AI가 목차·본문·표지를 만들어 전자책(.docx)으로 완성해드려요.',                icon: 'ebook',     palette: { bg: '#EDE8F6', deep: '#B6A4D8', accent: '#6A4FA0' }, personaName: '강지훈'  },
    { id: 16, numeral: 'XVI', latin: 'Webtoon', key: 'webtoon', name: '웹툰 보기',      tag: 'AI 웹툰 연재',   category: 'create',  desc: '향기 작가가 연재하는 웹툰을 회차별로 감상하세요. 한 컷씩 풀스크린으로.',                      icon: 'webtoon',   palette: { bg: '#FCE8EF', deep: '#F0A8C4', accent: '#C84D85' }, personaName: '향기(필명)' },
    { id: 17, numeral: 'XVII',latin: 'Hair',    key: 'hair',    name: '헤어스타일 진단',tag: 'AI 뷰티 컨설팅', category: 'life',    desc: '내 사진을 올리고 헤어스타일을 고르면 윤채린이 어울리는지 진단해드려요.',                      icon: 'hair',      palette: { bg: '#F3E9F4', deep: '#D4A8DC', accent: '#9B5FA8' }, personaName: '윤채린'  },
];
