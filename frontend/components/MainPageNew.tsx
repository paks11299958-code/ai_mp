...
export const FEATURES_GRID = [
    ...
    { id: 23, numeral: 'XXIII',latin: 'Outfit', key: 'outfit',  name: '전통의상 체험',tag: 'AI 세계 의상', catch: '한복·기모노 입은 나, 화보처럼 📸', category: 'life',    desc: '내 얼굴 사진만 올리면 한복·기모노·치파오 등 세계 전통의상을 입은 전신 화보를 만들어드려요.',       icon: 'outfit',    palette: { bg: '#F3E9F4', deep: '#D4A8DC', accent: '#8E6FB7' }, personaName: '윤채린',  releasedAt: '2026-07-12' },
