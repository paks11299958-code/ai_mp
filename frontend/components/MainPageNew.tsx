...
export const FEATURES_GRID = [
    ...
    { id: 23, numeral: 'XXIII',latin: 'Profile', key: 'outfit',  name: '프로필 사진',tag: 'AI 프로필', catch: '실사부터 지브리·픽사풍까지, 나만의 프사 📸', category: 'life',    desc: '내 얼굴 사진만 올리면 실내·야외·판타지는 물론 지브리·픽사·민화풍까지 다양한 컨셉의 프로필 사진을 만들어드려요.',       icon: 'outfit',    palette: { bg: '#F3E9F4', deep: '#D4A8DC', accent: '#8E6FB7' }, personaName: '윤채린',  releasedAt: '2026-07-12' },
...
export const FEATURE_SYNONYMS: Record<string, string[]> = {
    ...
    outfit:      ['프로필사진', '프사', '프로필', '증명사진', '컨셉사진', '실내', '야외', '판타지', '지브리', '픽사', '민화', '애니메이션', '인생네컷', '셀카', '사진', '전통의상'],
