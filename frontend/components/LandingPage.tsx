...
import { Menu, X, Bell, ChevronLeft, ChevronRight, Search } from 'lucide-react';
...
export const LandingPage: React.FC<LandingPageProps> = ({
    ...
    onPartnerBoardClick, theme, onThemeChange, heroImageUrl, categories = [],
}) => {
        ...
        <div className="min-h-screen bg-gray-950 text-gray-100">
            ...
            <section className="relative pt-32 pb-24 px-4 overflow-hidden" style={{ background: t.heroGradient }}>
                ...
                <div className="absolute pointer-events-none" style={{
                    ...
                    transform: 'rotate(-20deg)', filter: 'blur(1.5px)',
                }} />
                                        ...
                                        >
                                            <div className="relative" style={{ height: '320px' }}>
                                                ...
                                                <div className="absolute bottom-0 left-0 right-0 p-4">
                                                    ...
                                                    <p className="text-xs leading-relaxed line-clamp-2" style={{ color: '#aab0bd' }}>
                                                        {persona.description}
                                                    </p>
                                                </div>
                                            </div>
