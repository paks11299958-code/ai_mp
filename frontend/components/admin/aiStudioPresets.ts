...
const MODEL_NOTES: Record<string, string> = {
    ...
    // ★확대 후보정 2종은 2026-08-06 같은 시드로 A/B 실측해 우열을 확인했다.
    //   인물 얼굴을 2배 확대해 원본 픽셀로 비교: UltraSharp 는 속눈썹·잔머리가 한 올씩
    //   살고 모공까지 보이는 반면, RealESRGAN 은 매끈하지만 **피부 질감을 뭉개** 플라스틱처럼
    //   된다(확대 없음보다 인공적으로 보였다). 속도는 둘 다 10초로 같다.
    '4x-UltraSharp':           '★확대는 이걸로 — 머리카락·피부결이 또렷해집니다(기본)',
    RealESRGAN_x4:             '매끈하게 확대 — 인물은 피부결이 뭉개져 비추천',
};
