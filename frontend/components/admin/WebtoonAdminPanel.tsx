                        ...
                        <div className="rounded-xl p-4" style={{ background: T.card, border: `1px solid ${T.border}` }}>
                            ...
                            {selected.cuts.length === 0 ? (
                                ...
                                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-2"
                                    style={{ border: `1px solid ${T.border}`, borderRadius: 10, padding: 8, background: '#FCFBFE' }}>
                            ...
                            <p className="text-[11px] mt-2" style={{ color: T.inkSoft }}>총 <b style={{ color: T.accent }}>{selected.cuts.length}컷</b> · 💡 <b style={{ color: T.accent }}>마우스로 컷을 끌어다 놓으면</b> 순서가 바뀌어요. ◀▶로도 한 칸씩 조정, ✕로 삭제. 첫 컷이 목록 썸네일이 돼요.</p>
                        </div>
                    )}
                </div>
            </div>
