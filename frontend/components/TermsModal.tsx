...
const TermsContent: React.FC = () => (
    <div>
        ...
        <Section title="제2조 (정의)">
            <p>① "서비스"란 회사가 제공하는 AI 페르소나 채팅, 주식 분석, 명품 감정, 골프장 찾기, 오늘뉴스 등 일체의 서비스를 말합니다.<br />
        ...
        <Section title="제7조 (이용자가 입력한 콘텐츠에 대한 책임)">
            <p style={{ background: 'rgba(142,111,183,0.08)', borderRadius: 8, padding: '12px 14px' }}>
                ① "쇼츠 만들기" 등 이용자가 업종·상품 정보, 주제·소재, 사진 등을 직접 입력하여
                AI가 콘텐츠(대본·이미지·영상)를 생성하는 서비스의 경우, <strong>입력한 내용의
                사실관계·적법성과 그로 인해 생성된 콘텐츠에 대한 책임은 이용자 본인에게 있습니다.</strong><br /><br />
                ② 이용자는 다음 내용을 입력해서는 안 됩니다.<br />
                &nbsp;&nbsp;- 특정 개인·기업·단체를 저격·비방·조롱하거나 명예를 훼손하는 내용<br />
                &nbsp;&nbsp;- 사실과 다르거나 근거 없는 정보를 사실인 것처럼 단정하는 내용(허위사실 유포)<br />
                &nbsp;&nbsp;- 타인의 저작권·초상권·상표권 등 지식재산권을 침해하는 내용<br />
                &nbsp;&nbsp;- 실물과 다른 효능·성분·비교우위를 허위로 주장하는 과장 광고성 내용<br />
                ③ 이용자가 입력한 내용을 위반하여 제3자와 분쟁이 발생하거나 손해가 발생한 경우,
                그 책임은 전적으로 해당 이용자에게 있으며 회사는 책임을 지지 않습니다.<br />
                ④ 회사는 위 사항을 위반한 콘텐츠를 사전 통지 없이 삭제하거나 서비스 이용을
                제한할 수 있습니다.
            </p>
        </Section>
        ...
        <Section title="제8조 (면책 조항)">
            ...
            ② AI가 생성한 콘텐츠는 참고용이며, 투자·의료·법률 등 전문 분야에서의 최종 판단은 이용자 본인의 책임입니다.<br />
            ③ 이용자가 직접 입력한 내용을 기반으로 AI가 생성한 콘텐츠의 정확성·완전성에 대해
            회사는 보증하지 않으며, 이용자는 게시·공유 전 내용을 직접 확인할 책임이 있습니다.</p>
        </Section>
