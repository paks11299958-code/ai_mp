...
const PrivacyContent: React.FC = () => (
    <div>
        ...
        <Section title="제2조 (수집하는 개인정보 항목)">
            ...
            ④ <strong>얼굴·신체 이미지</strong>: 관상·손금·헤어스타일·미래의 나 등 이미지 기반 기능 이용 시
            이용자가 직접 업로드한 사진. 관상·손금 등 분석형 기능은 분석 즉시 처리 후 저장하지 않으며,
            헤어·미래의 나 등 결과 이미지 생성 기능은 아래 제3조의 기간 동안만 보관합니다.<br />
            ⑤ <strong>자동 수집</strong>: 접속 IP, 서비스 이용 기록, 결제 기록</p>
        </Section>
        ...
        <Section title="제3조 (개인정보의 보유 및 이용 기간)">
            ...
            &nbsp;&nbsp;- 미래의 나(나이 변환) 저장 이미지: 저장 후 90일<br />
