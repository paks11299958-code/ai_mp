                ...
                <div className="flex items-center justify-between px-5 py-3.5 shrink-0" style={{ borderBottom: `1px solid ${T.border}`, background: T.card }}>
                    ...
                    <div className="flex items-center gap-1">
                        <HelpButton
                            ...
                            accent={T.accent}
                            steps={[
                                { title: '회차 고르기', desc: '보고 싶은 회차를 누르면 웹툰이 열려요.' },
                                { title: '아래로 넘기며 보기', desc: '화면을 위에서 아래로 쭉 내리면서 컷을 봐요.' },
                                { title: '다음 화 기다리기', desc: '마지막 컷까지 보면 끝! 새 회차가 올라오면 또 만나요.' },
                            ]}
                        />
                ...
                <div className="px-4 pt-3 shrink-0">
                    <div className="flex items-start gap-2 rounded-xl px-3 py-2.5" style={{ background: '#F4ECFB', border: '1px solid #E0CDF0' }}>
                        ...
                        <p className="text-xs leading-relaxed" style={{ color: '#6B4F8A' }}>
                            <b style={{ color: '#7A5FA0' }}>그림은 생성형 AI</b>로 그렸어요. 작가 향기의 스토리에 AI 작화를 입힌 웹툰이에요. ✨
                        </p>
                    </div>
                </div>
