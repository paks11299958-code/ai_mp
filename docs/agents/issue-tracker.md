...
★2026-08-22에 Private 전환을 시도했으나 **Vercel 자동배포가 `BLOCKED`** 되어
**Public으로 되돌렸다**(운영 피해 없음). 사유 확인 후 재시도 예정이므로,
전환됐다고 단정하지 말고 **현재 상태를 먼저 확인**한다.

```sh
gh repo view paks11299958-code/ai_mp --json isPrivate
```
