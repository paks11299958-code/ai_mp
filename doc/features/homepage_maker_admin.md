...
> 2026-08-26 UI 뼈대. 화면: `시스템 > 홈페이지 생성`
...
- shared-api 생성·조회·승인 API
- DB 저장과 프로젝트 이력
- 서버2 `devai_start.py` 프리셋 연결
- 진행 상태·미리보기·체커 지적 화면
- 사용자 승인 후 Vercel 프로젝트·도메인 배포

오퍼스는 위 순서대로 한 단계씩 연결하고, 처음에는 운영 배포 없이 미리보기 생성까지 완주하는
통합 테스트를 먼저 만든다.
