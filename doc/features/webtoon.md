...
## AI 제작 안내 배너 (2026-06-24)
회차 목록(`WebtoonEpisodeList.tsx`) 헤더 아래에 AI 제작 안내 배너 추가(투명성+컨셉 자랑조, 퍼플 톤). 회차 고르기 전 모두가 보는 위치.
- ⚠️★**사실 정정**: 처음엔 "스토리부터 그림까지 AI"로 썼다가 **그림(작화)만 AI·스토리는 작가(사람)**로 정정. 최종 문구: "🎨 **그림은 생성형 AI**로 그렸어요. 작가 향기의 스토리에 AI 작화를 입힌 웹툰이에요. ✨". (AI 제작 표기는 사실과 정확히 일치해야 함.) 커밋 `5a473ae`→정정 `934ec66`.
